                        ...
                        ?>
                                ...
                                <div class="col-12 col-lg-5">
                                    ...
                                    <div class="single_product_desc">
                                        ...
                                        <!-- Add to Cart Form -->
                                        <!-- <form action="../products/addProduct.php" class="cart clearfix" method="post"> -->
                                    ...
                                    <div class="quantity">
                                        ...
                                        <button type="submit" name="add" class="btn amado-btn">Add to cart</button>
                                        <input type='hidden' name='product_id' value='<?php echo $row['id']; ?>'>
                                        <!-- <a href="cart-products.php?id=<?php echo $row['id'] ?>"> -->
                                        <!-- </form> -->
