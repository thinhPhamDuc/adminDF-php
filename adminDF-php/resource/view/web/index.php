                ...
                <div class="col-12">
                    <div class="search-content">
                        <form action="#" method="get">
                            ...
                            <button type="submit"><img src="../../../public/frontend/assets/img/core-img/search.png" alt=""></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="index.html"><img src="../../../public/frontend/assets/img/core-img/logo.png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    <li class="active"><a href="index.php">Product Page</a></li>
                    <li><a href="#">Shop</a></li>
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart-products.php" class="cart-nav"><img src="img/core-img/cart.png" alt=""> Cart
                    <?php
        ...
        <div class="products-catagories-area clearfix">
            ...
            <?php
                ...
                <div class="single-products-catagory clearfix">
                    <a href="detail-products.php?id=<?php echo $row['product_id'] ?>">
                    
                    <img class="card-img-top" src="<?php if (substr($row['images'], 3)) {
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="../../../public/frontend/assets/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
                            ...
                            <nav class="navbar navbar-expand-lg justify-content-end">
                                ...
                                <div class="collapse navbar-collapse" id="footerNavContent">
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="cart-products.php">Cart</a>
                                        </li>
                                        <li class="nav-item">
