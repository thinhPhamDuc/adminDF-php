...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="../../../public/frontend/assets/images/icon.png" />
    <!-- Bootstrap icons-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#!">ADMIN-DF</a>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <!-- Product price-->
                                        <h5 class="fw-bolder">Giá : <?php echo $row['price']; ?></h5>
                                        <hr>
                                        <h5 class="fw-bolder">Số lượng: <?php echo $row['stock']; ?></h5>
                                    </div>
                                </div>
                                <!-- Product actions-->
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detailShopping.php?id=<?php echo $row['product_id'] ?>">Chi tiết</a></div>
                                </div>
                            </div>
                        </div>
                <?php
