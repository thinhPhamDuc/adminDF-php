...
<head>
    ...
    <title>Adella Fashion 💚 Liên Hệ</title>
        ...
        <div class="shop-main-area">
            ...
            <div class="map-area pt-50">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div style="overflow:hidden;width: 100%;position: relative;"><iframe width="100%"
                                    height="410"
                    ...
                    <div class="row">
                            ...
                            <div class="contact-info mb-rsp-3">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>Email</span>
                                        <a href="#">adella_fashion@gmail.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="contact-form">
                                ...
                                <div class="single-form-3">
                                    <form action="#">
                                        <textarea name="massage" placeholder="Nội Dung" cols="30" rows="6"></textarea>
